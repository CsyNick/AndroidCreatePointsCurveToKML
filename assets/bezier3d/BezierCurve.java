...
boolean isUsingLinearInterPolationForZ = false;//z方向採用線性內插
...
public void showLineStringForBezierCurve(boolean bvalue) {

this.LineStringKmlObj.setVisibility(bvalue);
}
